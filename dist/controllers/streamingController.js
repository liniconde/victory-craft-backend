...
const handleDeleteMatchSession = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const ownerId = getAuthUserId(req);
        if (!ownerId) {
            res.status(401).json({ message: "Unauthorized", code: "unauthorized" });
        ...
        const result = yield (0, streamingService_1.deleteMatchSessionById)(req.params.id, ownerId);
...
exports.handleDeleteMatchSession = handleDeleteMatchSession;
