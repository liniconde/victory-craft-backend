...
class AgentPlanningService {
    ...
    plan(input) {
        return __awaiter(this, void 0, void 0, function* () {
            const parsedRequest = schemas_1.agentPlanRequestSchema.safeParse(input);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logger.error(JSON.stringify({
                    event: "agent_plan_provider_error",
                    message: (error === null || error === void 0 ? void 0 : error.message) || "Unknown provider error",
                }));
    ...
    normalizeOutput(request, summary, calls) {
        ...
        const validCalls = calls
            ...
            if (!call.name || typeof call.name !== "string") {
                this.logger.warn(JSON.stringify({
                    event: "agent_plan_invalid_call_name",
                }));
                return null;
            }
            ...
            if (!action) {
                this.logger.warn(JSON.stringify({
                    event: "agent_plan_unknown_action_filtered",
